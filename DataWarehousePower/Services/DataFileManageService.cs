...
namespace DataWarehousePower.Services
{
    public class DataFileManageService : IDataFileManageService
    {
        ...
        public async Task<DataFileManageListViewModel> GetListViewModelAsync(string userId, DataFileManageFilterViewModel? filter = null)
        {
            var dataFiles = await _repository.GetAllWithColumnsAsync(userId);
        ...
        public Task<List<string>> GetDistinctColumnValuesAsync(
            ...
            string? search = null,
            int take = 50)
            => _repository.GetDistinctColumnValuesAsync(userId, sourceDatabase, sourceTable, sourceSP, columnName, search, take);
